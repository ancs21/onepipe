...
```ts
static fromResponse(status, body?): APIError;
```
...
| Property | Type |
| ------ | ------ |
| <a id="latencyms"></a> `latencyMs` | `number` |
| <a id="message"></a> `message?` | `string` |
| <a id="name-14"></a> `name` | `string` |
| <a id="status-2"></a> `status` | [`HealthStatus`](#healthstatus) |
...
| Property | Type |
| ------ | ------ |
| <a id="checks"></a> `checks` | [`HealthCheckResult`](#healthcheckresult)[] |
| <a id="status-3"></a> `status` | [`HealthStatus`](#healthstatus) |
| <a id="timestamp-1"></a> `timestamp` | `string` |
...
| ------ | ------ | ------ |
| <a id="flushtracingonshutdown"></a> `flushTracingOnShutdown?` | `boolean` | Whether to flush OTEL traces on shutdown **Default** `true` |
| <a id="shutdowntimeout"></a> `shutdownTimeout?` | `number` | Grace period for shutdown in milliseconds **Default** `30000 (30 seconds)` |
...
| <a id="status-4"></a> `status?` | \| [`WorkflowStatus`](#workflowstatus) \| [`WorkflowStatus`](#workflowstatus)[] |
...
| <a id="services"></a> `services?` | [`ServiceDefinition`](#servicedefinition)[] | Microservices definitions |
...
| Property | Modifier | Type |
| ------ | ------ | ------ |
| <a id="name-17"></a> `name` | `readonly` | `string` |
...
| Property | Type |
| ------ | ------ |
| <a id="cleanupinterval"></a> `cleanupInterval?` | `number` |
| <a id="db-2"></a> `db?` | [`DBInstance`](#dbinstance) |
| <a id="defaultttl-1"></a> `defaultTtl?` | `number` |
...
| Property | Type | Description |
| ------ | ------ | ------ |
| <a id="connectiontimeout"></a> `connectionTimeout?` | `number` | How long to wait for a connection in ms (default: 30000) |
| <a id="idletimeout"></a> `idleTimeout?` | `number` | How long to keep idle connections in ms (default: 30000) |
| <a id="max"></a> `max?` | `number` | Maximum number of connections in the pool (default: 10) |
| <a id="min"></a> `min?` | `number` | Minimum number of connections in the pool |
...
| Property | Modifier | Type |
| ------ | ------ | ------ |
| <a id="name-19"></a> `name` | `readonly` | `string` |
...
| Property | Type |
| ------ | ------ |
| <a id="checks-1"></a> `checks` | [`HealthCheckResult`](#healthcheckresult)[] |
...
| Property | Type | Description |
| ------ | ------ | ------ |
| <a id="body"></a> `body?` | `unknown` | Request body (for POST/PUT/PATCH) |
| <a id="headers"></a> `headers?` | `Record`\<`string`, `string`\> | Additional headers |
| <a id="query-6"></a> `query?` | `Record`\<`string`, `string` \| `number` \| `boolean`\> | Query parameters |
| <a id="timeout-1"></a> `timeout?` | `number` | Override timeout for this request |
...
| <a id="db-3"></a> `db` | [`DBContext`](#dbcontext) |
| <a id="headers-1"></a> `headers` | `Headers` |
| <a id="params"></a> `params` | `Record`\<`string`, `string`\> |
| <a id="query-7"></a> `query` | `Record`\<`string`, `string`\> |
...
| <a id="name-21"></a> `name` | `readonly` | `string` |
...
| <a id="db-4"></a> `db?` | [`DBInstance`](#dbinstance) |
...
| Property | Modifier | Type | Description |
| ------ | ------ | ------ | ------ |
| <a id="baseurl"></a> `baseUrl` | `readonly` | `string` | Base URL |
| <a id="name-23"></a> `name` | `readonly` | `string` | Service name |
...
| Property | Type | Description |
| ------ | ------ | ------ |
| <a id="baseurl-1"></a> `baseUrl` | `string` | Base URL for the service |
| <a id="headers-2"></a> `headers` | `Record`\<`string`, `string`\> | Default headers to include in all requests |
| <a id="name-24"></a> `name` | `string` | Service name (used for tracing and dependency graph) |
| <a id="retries"></a> `retries` | `number` | Number of retries for failed requests (default: 0) |
| <a id="retrydelay"></a> `retryDelay` | `number` | Retry delay in milliseconds (default: 1000) |
| <a id="timeout-2"></a> `timeout` | `number` | Request timeout in milliseconds (default: 30000) |
...
| Property | Type |
| ------ | ------ |
| <a id="headers-3"></a> `headers?` | `Record`\<`string`, `string`\> |
| <a id="name-25"></a> `name` | `string` |
| <a id="retries-1"></a> `retries?` | `number` |
| <a id="retrydelay-1"></a> `retryDelay?` | `number` |
| <a id="timeout-3"></a> `timeout?` | `number` |
...
| Property | Type | Description |
| ------ | ------ | ------ |
| <a id="basepath-3"></a> `basePath?` | `string` | Base path for routing (e.g., "/api/users") |
| <a id="depends"></a> `depends?` | `string`[] | Other services this service depends on |
| <a id="entrypoint"></a> `entrypoint` | `string` | Path to entrypoint file |
| <a id="gateway"></a> `gateway?` | `boolean` | Whether this service is the public gateway |
| <a id="name-26"></a> `name` | `string` | Service name (used in Docker/K8s) |
| <a id="port-2"></a> `port?` | `number` | Port the service listens on (default: 3000) |
| <a id="replicas-1"></a> `replicas?` | `number` | Number of replicas (default: 1) |
...
| Property | Type |
| ------ | ------ |
| <a id="handler-5"></a> `handler` | () => `void` \| `Promise`\<`void`\> |
...
| Property | Modifier | Type |
| ------ | ------ | ------ |
| <a id="name-28"></a> `name` | `readonly` | `string` |
...
| <a id="storage"></a> `storage?` | `"sqlite"` \| `"memory"` \| `"postgresql"` |
...
| Property | Type | Description |
| ------ | ------ | ------ |
| <a id="timeout-4"></a> `timeout?` | `string` | Timeout for this execution |
...
| <a id="status-5"></a> `status` | `"pending"` \| `"running"` \| `"completed"` \| `"failed"` |
...
| <a id="timeout-5"></a> `timeout?` | `string` |
...
| ------ | ------ |
| `key` | `string` |
| `data` | \| `string` \| `Blob` \| `ArrayBuffer` \| `Uint8Array`\<`ArrayBufferLike`\> \| `ReadableStream`\<`any`\> |
...
| <a id="name-30"></a> `name` | `readonly` | `string` |
...
| <a id="prefix-2"></a> `prefix?` | `string` | Filter by prefix |
...
| <a id="basepath-4"></a> `basePath` | `readonly` | `string` |
| <a id="name-32"></a> `name` | `readonly` | `string` |
...
| Property | Type | Description |
| ------ | ------ | ------ |
| <a id="name-33"></a> `name` | `string` | Original filename from the client |
...
| Property | Modifier | Type | Description |
| ------ | ------ | ------ | ------ |
| <a id="db-5"></a> `db` | `readonly` | [`DBContext`](#dbcontext) | Database access (read-only in workflow, use step for writes) |
...
| <a id="status-6"></a> `status` | [`WorkflowStatus`](#workflowstatus) |
...
| Property | Modifier | Type |
| ------ | ------ | ------ |
| <a id="name-34"></a> `name` | `readonly` | `string` |
...
```ts
type ServiceRegistryInstance<T> = T & object;
```
...
| Name | Type | Description |
| ------ | ------ | ------ |
| `serviceNames` | `string`[] | Get all registered service names |
| `healthCheck()` | () => `Promise`\<`Record`\<`string`, \{ `error?`: `string`; `healthy`: `boolean`; `latency?`: `number`; \}\>\> | Check health of all services |

#### Type Parameters

| Type Parameter |
| ------ |
| `T` *extends* `Record`\<`string`, [`ServiceClientInstance`](#serviceclientinstance)\> |
...
```ts
function getServiceUrl(name, fallback): string;
```
...
| Name | Type | Description |
| ------ | ------ | ------ |
| <a id="delete-8"></a> `delete()` | (`url`, `options?`) => `Promise`\<`Response`\> | Make a DELETE request |
| <a id="get-15"></a> `get()` | (`url`, `options?`) => `Promise`\<`Response`\> | Make a GET request |
| <a id="patch-4"></a> `patch()` | (`url`, `body?`, `options?`) => `Promise`\<`Response`\> | Make a PATCH request with JSON body |
| <a id="post-2"></a> `post()` | (`url`, `body?`, `options?`) => `Promise`\<`Response`\> | Make a POST request with JSON body |
| <a id="put-2"></a> `put()` | (`url`, `body?`, `options?`) => `Promise`\<`Response`\> | Make a PUT request with JSON body |
...
| Name | Type | Description |
| ------ | ------ | ------ |
| `create()` | () => `LifecycleBuilder` | Create a new lifecycle builder |
...
| Name | Type | Default value |
| ------ | ------ | ------ |
| <a id="create-22"></a> `create()` | (`name`) => `RESTBuilder` | `RESTBuilder.create` |
...
| Name | Type | Default value |
| ------ | ------ | ------ |
| <a id="create-23"></a> `create()` | () => `ServerBuilder` | `ServerBuilder.create` |
...
| Name | Type |
| ------ | ------ |
| `create()` | (`name`) => `ServiceClientBuilder` |
...
| Name | Type | Default value |
| ------ | ------ | ------ |
| <a id="create-30"></a> `create()` | (`name`) => `StorageBuilder` | `StorageBuilder.create` |
...
| Name | Type | Default value |
| ------ | ------ | ------ |
| <a id="create-33"></a> `create()` | (`name`) => `WorkflowBuilder`\<`unknown`, `unknown`\> | `WorkflowBuilder.create` |
